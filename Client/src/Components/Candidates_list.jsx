  ...
  var candidates_details = [
    {
      ...
      Party: "Party : BJP",
      Qualifications:
        "Lorem ipsum, dolor sit amet consectetur adipisicing elit.Illum unde sequi labore placeat repudiandae vitae iusto excepturi sapiente a vel!",
    ...
    <div className="main" id="Cand">
      ...
      <div className="Home">
        <div className="text-box">
          ...
          <div className="Res">
            <div className="candidates">{CandiCard}</div>
            <div className="candidates_details">{descriptCard}</div>
          </div>
        </div>
      </div>
    </div>
