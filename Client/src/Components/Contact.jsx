  ...
  render() { 
    function year() {
        ...
        <div className="content">
          ...
          <p>Hello Everyone! Have a great day :) I am here to help you.
            <br />If you want to know something or you have any suggestions feel free to contact us.
          </p>
        </div>
        <div className="container_contact">
          <div className="contactForm">
            <form>
              ...
              <div className="inputbox">
                <textarea placeholder="Message" type="text" name required="required" defaultValue={""} />
              </div>
              <div className="inputbox">
        ...
        <div className="contactInfo">
          <div className="box" id="b1">
            <div className="icon"><i className="fa fa-map-marker" aria-hidden="true" /></div>
            <div className="text">
              <h3>Address</h3>
              <p>Indian Institute of Information Technology, Vadodara
                <br />Gandhinagar, Gujarat,<br />382028
              </p>
            </div>
          </div>
